...
set_property IOSTANDARD LVCMOS33 [get_ports {a_cnv_p[3]}]
## MC1-16
set_property PACKAGE_PIN V9 [get_ports {gp_lvds_p[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gp_lvds_p[3]}]
## MC1-17
set_property PACKAGE_PIN Y9 [get_ports {a_cnv_n[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_cnv_n[3]}]
## MC1-18
set_property PACKAGE_PIN V8 [get_ports {gp_lvds_n[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gp_lvds_n[3]}]
## MC1-19
set_property PACKAGE_PIN R6 [get_ports {a_d_p[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_d_p[3]}]
## MC1-20
set_property PACKAGE_PIN V7 [get_ports {gp_lvds_p[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gp_lvds_p[2]}]
## MC1-21
set_property PACKAGE_PIN T6 [get_ports {a_d_n[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_d_n[3]}]
## MC1-22
set_property PACKAGE_PIN W7 [get_ports {gp_lvds_n[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gp_lvds_n[2]}]
## MC1-23
set_property PACKAGE_PIN U6 [get_ports {a_clk_p[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_clk_p[3]}]
## MC1-24
set_property PACKAGE_PIN Y8 [get_ports {gp_lvds_p[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gp_lvds_p[1]}]
## MC1-25
set_property PACKAGE_PIN V5 [get_ports {a_clk_n[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_clk_n[3]}]
## MC1-26
set_property PACKAGE_PIN Y7 [get_ports {gp_lvds_n[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gp_lvds_n[1]}]
## MC1-27
set_property PACKAGE_PIN T5 [get_ports {a_dco_p[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_dco_p[3]}]
## MC1-28
set_property PACKAGE_PIN W6 [get_ports {a_cnv_p[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_cnv_p[2]}]
## MC1-29
set_property PACKAGE_PIN U5 [get_ports {a_dco_n[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_dco_n[3]}]
## MC1-30
set_property PACKAGE_PIN W5 [get_ports {a_cnv_n[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_cnv_n[2]}]
## MC1-31
set_property PACKAGE_PIN AA5 [get_ports {a_d_p[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_d_p[2]}]
## MC1-32
set_property PACKAGE_PIN R4 [get_ports {a_dco_p[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_dco_p[2]}]
## MC1-33
set_property PACKAGE_PIN AB5 [get_ports {a_d_n[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_d_n[2]}]
## MC1-34
set_property PACKAGE_PIN T4 [get_ports {a_dco_n[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_dco_n[2]}]
## MC1-35
#set_property PACKAGE_PIN nan [get_ports {}]
#set_property IOSTANDARD  [get_ports {}]
## MC1-36
...
set_property IOSTANDARD LVCMOS33 [get_ports {a_clk_p[2]}]
## MC1-38
set_property PACKAGE_PIN Y4 [get_ports {a_dco_p[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_dco_p[0]}]
## MC1-39
set_property PACKAGE_PIN AB6 [get_ports {a_clk_n[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_clk_n[2]}]
## MC1-40
set_property PACKAGE_PIN AA4 [get_ports {a_dco_n[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_dco_n[0]}]
## MC1-41
set_property PACKAGE_PIN R3 [get_ports {a_cnv_p[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_cnv_p[0]}]
## MC1-42
set_property PACKAGE_PIN Y6 [get_ports {gp_lvds_p[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gp_lvds_p[0]}]
## MC1-43
set_property PACKAGE_PIN R2 [get_ports {a_cnv_n[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_cnv_n[0]}]
## MC1-44
set_property PACKAGE_PIN AA6 [get_ports {gp_lvds_n[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gp_lvds_n[0]}]
## MC1-45
set_property PACKAGE_PIN Y3 [get_ports {a_d_p[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_d_p[0]}]
## MC1-46
set_property PACKAGE_PIN AA8 [get_ports {a_en0_hv[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_en0_hv[0]}]
## MC1-47
set_property PACKAGE_PIN AA3 [get_ports {a_d_n[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_d_n[0]}]
## MC1-48
set_property PACKAGE_PIN AB8 [get_ports {a_en0_hv[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_en0_hv[1]}]
## MC1-49
set_property PACKAGE_PIN U2 [get_ports {a_clk_p[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_clk_p[0]}]
## MC1-50
set_property PACKAGE_PIN U3 [get_ports {a_en0_hv[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_en0_hv[2]}]
## MC1-51
set_property PACKAGE_PIN V2 [get_ports {a_clk_n[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_clk_n[0]}]
## MC1-52
set_property PACKAGE_PIN V3 [get_ports {a_en0_hv[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_en0_hv[3]}]
## MC1-53
set_property PACKAGE_PIN W2 [get_ports {a_cnv_p[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_cnv_p[1]}]
## MC1-54
set_property PACKAGE_PIN W1 [get_ports {a_en_hv[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_en_hv[1]}]
## MC1-55
#set_property PACKAGE_PIN nan [get_ports {}]
#set_property IOSTANDARD  [get_ports {}]
## MC1-56
...
set_property IOSTANDARD LVCMOS33 [get_ports {a_cnv_n[1]}]
## MC1-58
set_property PACKAGE_PIN Y1 [get_ports {a_en_hv[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_en_hv[2]}]
## MC1-59
set_property PACKAGE_PIN T1 [get_ports {a_d_p[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_d_p[1]}]
## MC1-60
set_property PACKAGE_PIN AB3 [get_ports {a_en_hv[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_en_hv[3]}]
## MC1-61
set_property PACKAGE_PIN U1 [get_ports {a_d_n[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_d_n[1]}]
## MC1-62
#set_property PACKAGE_PIN AB2 [get_ports {}]
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
## MC1-63
set_property PACKAGE_PIN AA1 [get_ports {a_clk_p[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_clk_p[1]}]
## MC1-64
#set_property PACKAGE_PIN Y13 [get_ports {}]
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
## MC1-65
set_property PACKAGE_PIN AB1 [get_ports {a_clk_n[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_clk_n[1]}]
## MC1-66
...
set_property IOSTANDARD LVCMOS33 [get_ports {a_dco_p[1]}]
## MC1-78
#set_property PACKAGE_PIN nan [get_ports {}]
#set_property IOSTANDARD  [get_ports {}]
## MC1-79
set_property PACKAGE_PIN W4 [get_ports {a_dco_n[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {a_dco_n[1]}]
## MC1-80
#set_property PACKAGE_PIN nan [get_ports {}]
#set_property IOSTANDARD  [get_ports {}]
## MC2-1
...
## MC2-30
set_property PACKAGE_PIN M2 [get_ports {ds_sdo[1]}]
...
## MC2-32
set_property PACKAGE_PIN K6 [get_ports {ds_sclk[1]}]
...
## MC2-34
set_property PACKAGE_PIN J6 [get_ports {ds_csb[1]}]
...
## MC2-38
set_property PACKAGE_PIN L3 [get_ports {ds_sdi[1]}]
...
## MC2-40
set_property PACKAGE_PIN K3 [get_ports {ds_sdo[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ds_sdo[2]}]
## MC2-41
set_property PACKAGE_PIN K1 [get_ports {d_csb[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {d_csb[0]}]
## MC2-42
set_property PACKAGE_PIN J5 [get_ports {ds_sclk[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ds_sclk[2]}]
## MC2-43
set_property PACKAGE_PIN J1 [get_ports {d_sdi[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {d_sdi[0]}]
## MC2-44
set_property PACKAGE_PIN H5 [get_ports {ds_csb[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ds_csb[2]}]
## MC2-45
set_property PACKAGE_PIN H3 [get_ports {d_sclk[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {d_sclk[0]}]
## MC2-46
set_property PACKAGE_PIN H2 [get_ports {ds_sdi[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ds_sdi[2]}]
## MC2-47
...
## MC2-74
set_property PACKAGE_PIN Y14 [get_ports {en_ipump[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {en_ipump[1]}]
## MC2-75
set_property PACKAGE_PIN Y11 [get_ports {gpio[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[0]}]
## MC2-76
set_property PACKAGE_PIN Y12 [get_ports {en_ipump[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {en_ipump[2]}]
## MC2-77
